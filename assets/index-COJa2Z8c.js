...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yo(e,t,n){let r=new Float32Array(io),i=new W(0,1,0);return new Qi({name:`SphericalGaussianBlur`,defines:{n:io,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:So(),fragmentShader:`
	...
	`}var Co=class extends dn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ri(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;class j{constructor(e){this.props=e||{},this.uniforms=this.props.material?.uniforms,this.scene=null,this.camera=null,this.material=null,this.geometry=null,this.plane=null}init(){this.scene=new Zn,this.camera=new xa,this.uniforms&&(this.material=new $i(this.props.material),this.geometry=new Ui(2,2),this.plane=new mi(this.geometry,this.material),this.scene.add(this.plane))}update(){O.renderer.setRenderTarget(this.props.output||null),O.renderer.render(this.scene,this.camera),O.renderer.setRenderTarget(null)}}class re extends j{constructor(e){super({material:{vertexShader:te,fragmentShader:ne,uniforms:{boundarySpace:{value:e.cellScale},px:{value:e.cellScale},fboSize:{value:e.fboSize},velocity:{value:e.src.texture},dt:{value:e.dt},isBFECC:{value:!0}}},output:e.dst}),this.uniforms=this.props.material.uniforms,this.init()}init(){super.init(),this.createBoundary()}createBoundary(){let e=new Gr,t=new Float32Array([-1,-1,0,-1,1,0,-1,1,0,1,1,0,1,1,0,1,-1,0,1,-1,0,-1,-1,0]);e.setAttribute(`position`,new Ar(t,3));let n=new $i({vertexShader:`
  attribute vec3 position;
  uniform vec2 px;
  precision highp float;
  varying vec2 uv;
...
`,fragmentShader:ne,uniforms:this.uniforms});this.line=new Li(e,n),this.scene.add(this.line)}update({dt:e,isBounce:t,BFECC:n}){this.uniforms.dt.value=e,this.line.visible=t,this.uniforms.isBFECC.value=n,super.update()}}class M extends j{constructor(e){super({output:e.dst}),this.init(e)}init(e){super.init();let t=new Ui(1,1),n=new $i({vertexShader:`
    precision highp float;
    attribute vec3 position;
    attribute vec2 uv;
    uniform vec2 center;
...
`,uniforms:{boundarySpace:{value:e.boundarySpace},velocity:{value:e.src.texture},px:{value:e.cellScale},dt:{value:e.dt}}},output:e.dst}),this.init()}update({vel:e}){this.uniforms.velocity.value=e.texture,super.update()}}class oe extends j{constructor(e){super({material:{vertexShader:te,fragmentShader:`
    precision highp float;
...
`,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new U},palette:{value:f},bgColor:{value:_}}})),this.scene.add(this.output)}addScene(e){this.scene.add(e)}resize(){this.simulation.resize()}render(){O.renderer.setRenderTarget(null),O.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class le{constructor(e){this.props=e,O.init(e.$wrapper),A.init(e.$wrapper),A.autoIntensity=e.autoIntensity,A.takeoverDuration=e.takeoverDuration,this.lastUserInteraction=performance.now(),A.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new ee(A,this,{enabled:e.autoDemo,speed:e.autoSpeed,resumeDelay:e.autoResumeDelay,rampDuration:e.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener(`resize`,this._resize),this._onVisibility=()=>{document.hidden?this.pause():E.current&&this.start()},document.addEventListener(`visibilitychange`,this._onVisibility),this.running=!1}init(){this.props.$wrapper.prepend(O.renderer.domElement),this.output=new ce}resize(){O.resize(),this.output.resize()}render(){this.autoDriver&&this.autoDriver.update(),A.update(),O.update(),this.output.update()}loop(){this.running&&(this.render(),C.current=requestAnimationFrame(this._loop))}start(){this.running||(this.running=!0,this._loop())}pause(){this.running=!1,C.current&&=(cancelAnimationFrame(C.current),null)}dispose(){try{if(window.removeEventListener(`resize`,this._resize),document.removeEventListener(`visibilitychange`,this._onVisibility),A.dispose(),O.renderer){let e=O.renderer.domElement;e&&e.parentNode&&e.parentNode.removeChild(e),O.renderer.dispose(),O.renderer.forceContextLoss()}}catch{}}}let ue=b.current;ue.style.position=ue.style.position||`relative`,ue.style.overflow=ue.style.overflow||`hidden`;let de=new le({$wrapper:ue,autoDemo:p,autoSpeed:m,autoIntensity:h,takeoverDuration:g,autoResumeDelay:v,autoRampDuration:y});x.current=de,(()=>{if(!x.current)return;let u=x.current.output?.simulation;if(!u)return;let d=u.options.resolution;Object.assign(u.options,{mouse_force:e,cursor_size:t,isViscous:n,viscous:r,iterations_viscous:i,iterations_poisson:a,dt:o,BFECC:s,resolution:c,isBounce:l}),c!==d&&u.resize()})(),de.start();let fe=new IntersectionObserver(e=>{let t=e[0],n=t.isIntersecting&&t.intersectionRatio>0;E.current=n,x.current&&(n&&!document.hidden?x.current.start():x.current.pause())},{threshold:[0,.01,.1]});fe.observe(ue),T.current=fe;let pe=new ResizeObserver(()=>{x.current&&(D.current&&cancelAnimationFrame(D.current),D.current=requestAnimationFrame(()=>{x.current&&x.current.resize()}))});return pe.observe(ue),S.current=pe,()=>{if(C.current&&cancelAnimationFrame(C.current),S.current)try{S.current.disconnect()}catch{}if(T.current)try{T.current.disconnect()}catch{}x.current&&x.current.dispose(),x.current=null}},[s,t,o,l,n,a,i,e,c,r,u,p,m,h,g,v,y]),(0,_.useEffect)(()=>{let u=x.current;if(!u)return;let d=u.output?.simulation;if(!d)return;let f=d.options.resolution;Object.assign(d.options,{mouse_force:e,cursor_size:t,isViscous:n,viscous:r,iterations_viscous:i,iterations_poisson:a,dt:o,BFECC:s,resolution:c,isBounce:l}),u.autoDriver&&(u.autoDriver.enabled=p,u.autoDriver.speed=m,u.autoDriver.resumeDelay=v,u.autoDriver.rampDurationMs=y*1e3,u.autoDriver.mouse&&(u.autoDriver.mouse.autoIntensity=h,u.autoDriver.mouse.takeoverDuration=g)),c!==f&&d.resize()},[e,t,n,r,i,a,o,s,c,l,p,m,h,g,v,y]),(0,w.jsx)(`div`,{ref:b,className:`liquid-ether-container ${f||``}`,style:d})}function ll(){let e=(0,C.c)(4),t,n;e[0]===Symbol.for(`react.memo_cache_sentinel`)?(t={position:`relative`,minHeight:`100vh`},n={position:`fixed`,inset:0,zIndex:0},e[0]=t,e[1]=n):(t=e[0],n=e[1]);let r;e[2]===Symbol.for(`react.memo_cache_sentinel`)?(r=[`#5227FF`,`#FF9FFC`,`#B497CF`],e[2]=r):r=e[2];let i;return e[3]===Symbol.for(`react.memo_cache_sentinel`)?(i=(0,w.jsxs)(`div`,{style:t,children:[(0,w.jsx)(`div`,{style:n,children:(0,w.jsx)(cl,{colors:r,mouseForce:20,cursorSize:100,isViscous:!0,viscous:30,iterationsViscous:32,iterationsPoisson:32,resolution:.5,isBounce:!1,autoDemo:!0,autoSpeed:.5,autoIntensity:2.2,takeoverDuration:.25,autoResumeDelay:3e3,autoRampDuration:.6,style:{width:`100%`,height:`100%`}})}),(0,w.jsxs)(`div`,{style:{position:`relative`,zIndex:1},children:[(0,w.jsx)(T,{}),(0,w.jsx)(E,{}),(0,w.jsx)(O,{}),(0,w.jsx)(A,{}),(0,w.jsx)(j,{}),(0,w.jsx)(re,{})]})]}),e[3]=i):i=e[3],i}(0,v.createRoot)(document.getElementById(`root`)).render((0,w.jsx)(_.StrictMode,{children:(0,w.jsx)(ll,{})}));